...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring()
                .antMatchers("/user-service/accesstoken_reset")
                .antMatchers("/css/**") ;
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/",
                        ...
                        "/**/*.html",
                        "/**/*.css",
                        "/**/*.js").permitAll() // 위 경로는 누구나 접근 가능
                .antMatchers("/user-service/signup","/user-service/signin","/user-service/welcome", "/user-service/accesstoken_reset" ).permitAll()
                .antMatchers("/user-service/checkUsernameAvailability", "/user-service/checkEmailAvailability").permitAll()
                .anyRequest().authenticated() //그 외 나머지 요청은 모두 인증된 회원만 접근가능
                .and()
